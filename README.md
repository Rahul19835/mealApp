...
1. Clone or download the repository to your local machine server(XAMPP, WAMP)
2. Go to browser and type localhost/your project file name
...
Check out the live demo of the application at https://rahul19835.github.io/mealApp/
